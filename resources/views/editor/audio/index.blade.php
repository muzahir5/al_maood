...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{url('editor/createAudio')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="http://localhost/al-maood/editor/audios text-white-50"></i> Add Audio</a>
                    </div>
                            ...
                            @if($audios)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('editor/updateAudioStatus' , $audio->id)}}" title="Click to InActive status" > Active </a>
                                        @else
                                        <a href="{{url('editor/updateAudioStatus' ,$audio->id)}}" title="Click to Activate status" > InActive </a>
                                        @endif
                                    </td>
                                    ...
                                    <td>{{$audio->view_by}}</td>                  
                                    <td><a href="{{url('editor/editAudio' ,$audio->id )}} ">Edit</a> |Delete</td>
                                    <td>
                                    <!-- {{$audio->audio_url}} -->
