                                        ...
                                        <tr id="{{$i}}">
                                            ...
                                            <div class="list-group def_audios">
                                                <span class="list-group-item list_audio"style="margin: 1px;">
                                                    <img alt="audio img" style="border-radius: 14px; width: 72px;float: left;margin-right: 5px;"
                                                     src="{{$file_path}}/{{$audio->audio_img ? $audio->audio_img : $category->category_img}}">
                                                    <h4 class="list-group-item-heading">{{$audio->title}}</h4>
                                                    <p class="list-group-item-text">{{$category->name}}
                                                    <i class="fas fa-play list_play_<?php echo $i;?>" style="float: right;"
                                                        onclick="playaudio(<?php echo $i;?> , {{$audio->id}} )"></i> </p>
                                                </span> 
                                            </div>
                                            </td>
                                        </tr>
